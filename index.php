  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/logo.png"  style="width: 147px;margin: 0px;">Karki Book store</a>
        </div>
          ...
          <div class="row">
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  ...
                  <div>
                      ...
                      <a href="https://www.facebook.com/jeeneesa.karkee">
